...
const ServicePageLayout = ({ title, bgImage, children }) => {
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
            {/* Hero Section */}
            <div className="relative bg-gray-900 h-64 sm:h-80 flex items-center justify-center">
                {bgImage && (
                ...
                <div className="relative z-10 text-center px-4">
                    <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4 drop-shadow-md">{title}</h1>

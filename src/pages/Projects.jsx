  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen transition-colors duration-200 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Introduction */}
        <div className="mb-12 bg-gradient-to-r from-red-50 to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-lg p-8">
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-red-600 to-red-700 rounded-lg p-8 text-center text-white">
